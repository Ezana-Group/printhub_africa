/**
 * POST /api/admin/settings/my-account/2fa/disable — Disable 2FA for the current user.
 * Requires current account password. Staff/Admin only. Clears totpSecret, twoFaMethod, otpCodeHash, otpExpiresAt.
 */
