/**
 * POST /api/admin/settings/my-account/2fa/setup-method — Enable 2FA via email or SMS (no TOTP).
  ...
  return NextResponse.json({
    ...
    message:
      parsed.data.method === "email"
        ...
        : "2FA enabled. We'll send a code to your phone when you sign in (ensure AT_API_KEY is set for SMS).",
  });
}
