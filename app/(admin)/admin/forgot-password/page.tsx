          ...
          <CardContent>
            {success ? (
              <div className="space-y-6 py-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="bg-[#FF4D00]/10 p-6 rounded-2xl border border-[#FF4D00]/20 text-center space-y-3">
                  <div className="h-12 w-12 bg-[#FF4D00]/20 rounded-full flex items-center justify-center mx-auto mb-2">
                    <CheckCircle2 className="h-6 w-6 text-[#FF4D00]" />
                  </div>
