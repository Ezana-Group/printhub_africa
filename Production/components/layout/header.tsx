          ...
          >
            <div className="flex flex-col h-full min-h-0">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b flex-shrink-0">
                <span className="font-display font-bold text-lg text-[#0A0A0A]">{siteName}</span>
              ...
              <div className="flex-1 overflow-y-auto overscroll-contain min-h-0">
                <nav className="p-6 space-y-1">
                  ...
                  <MobileNavLink href="/about" label="About Us" onClick={() => setMobileOpen(false)} />
                  ...
                  <MobileNavLink href="/catalogue" label="Print-on-Demand Catalogue" onClick={() => setMobileOpen(false)} sub />
