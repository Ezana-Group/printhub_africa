...
export const ROUTE_TO_PERMISSION: Record<string, PermissionKey | string> = {
  ...
  "/admin/deliveries": "orders_view",
  "/admin/support": "orders_view",
  ...
  "/admin/corporate": "orders_view",
  "/admin/corporate/applications": "orders_view",
  "/admin/corporate-accounts": "orders_view",
  "/admin/finance": "finance_view",
  "/admin/finance/invoices": "finance_view",
  "/admin/refunds": "finance_view",
  ...
  "/admin/catalogue/queue": "products_view",
