...
export async function sendVerificationEmail(email: string, token: string) {
  ...
  const defaultHtml = `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        ...
        <p><a href="${url}" style="color: #CC3D00; font-weight: bold;">Verify my email</a></p>
...
export async function sendPasswordResetEmail(email: string, token: string, baseUrlOverride?: string) {
  ...
  const defaultHtml = `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        ...
        <p><a href="${url}" style="color: #CC3D00; font-weight: bold;">Reset password</a></p>
        <p>Or copy this link: ${url}</p>
...
export async function sendStaffInviteEmail(
  ...
  const defaultHtml = `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto;">
        ...
        <p><a href="${url}" style="color: #CC3D00; font-weight: bold;">Set your password</a></p>
        <p>Or copy this link: ${url}</p>
